const DIDReceivedAsk = `<!DOCTYPE html>
<html>
   <head>
...
<body style="background-color: #4747c1;">
    ...
    On this mobile screen, the user could continue to interact with the UX/UI that is necessary,
    show data or approve, reject flow options.
   </div>
   ...
   We continue with the process of issuing your credential using KAYTRUST PROVIDER once you have completed your information on your other screen.
   </div>

</body>
</html>`

export default DIDReceivedAsk;