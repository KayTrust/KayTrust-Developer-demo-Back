...
<body style="background-color: #4747c1;">
    ...
    Your credential has been created using KayTrust Provider.
   </div>
   <div style="color: white; font-size: 1.5rem; font-weight: 700; text-align: center; padding: 5rem;">
   Your credential will automatically arrive in your wallet if you are registered with the KayTrust Demo Provider or you can also download the credential from the following button:
   </div>
